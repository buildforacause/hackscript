...
<body>
    <div class="container  mt-5">
        ...
        <form class="row needs-validation" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" novalidate>
            <div class="form-group row mb-3 mt-3">
                ...
                <center>
                    <div id="team_check" style="margin-top: 2%; font-weight: bold;"></div>
                </center>
            ...
            <center>
                <h3 class="m-4">Team Member 1 (Team Leader)</h3>
            </center>
            <div class="col-md-6">
    ...
    if (isset($_POST["submit"])) {
        ...
        if ((count($member_email_array)) != (count(array_unique($member_email_array))) || in_array($leader_email, array_unique($member_email_array))) {
            ...
            echo "<script> swal('Duplicate Email','Email Should be unique for every member', 'error');</script>";
        } else {
